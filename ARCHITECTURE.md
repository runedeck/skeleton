...
The [review ceremony specification](docs/specs/agentic-review-lanes/spec.md#requirement-paid-lane-admission) defines request handling and current-head evidence reuse.
